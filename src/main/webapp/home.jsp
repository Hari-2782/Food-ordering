...
<head>
  ...
  <!-- 
    - custom css link
  -->
  <link rel="stylesheet" href="./useable/css/style.css">
  ...
  <!-- 
    - preload images
  -->
  <link rel="preload" as="image" href="./useable/images/hero-banner.png" media="min-width(768px)">
  <link rel="preload" as="image" href="./useable/images/hero-banner-bg.png" media="min-width(768px)">
  <link rel="preload" as="image" href="./useable/images/hero-bg.jpg">
...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <h1>
        <a href="#" class="logo">Eatwell<span class="span">.</span></a>
      </h1>
...
<a href="login.jsp">
  ...
  <main>
    <article>
      ...
      <section class="hero" id="home" style="background-image: url('./useable/images/hero-bg.jpg')">
        <div class="container">
          ...
          <figure class="hero-banner">
            <img src="./useable/images/hero-banner-bg.png" width="820" height="716" alt="" aria-hidden="true"
              class="w-100 hero-img-bg">

            <img src="./useable/images/hero-banner.png" width="700" height="637" loading="lazy" alt="Burger"
          ...
          <ul class="promo-list has-scrollbar">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title">Mexican Pizza</h3>

                <p class="card-text">
                  Food is any substance consumed to provide nutritional support for an organism.
                </p>

                <img src="./useable/images/promo-1.png" width="300" height="300" loading="lazy" alt="Maxican Pizza"
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="./useable/images/promo-2.png" width="300" height="300" loading="lazy" alt="Soft Drinks"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="./useable/images/promo-3.png" width="300" height="300" loading="lazy" alt="French Fry"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="./useable/images/promo-4.png" width="300" height="300" loading="lazy" alt="Burger Kingo"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="./useable/images/promo-5.png" width="300" height="300" loading="lazy" alt="Chicken Masala"
                  class="w-100 card-banner">
      ...
      <section class="section section-divider gray about" id="about">
        <div class="container">
          ...
          <div class="about-banner">
            <img src="./useable/images/about-banner.png" width="509" height="459" loading="lazy" alt="Burger with Drinks"
              class="w-100 about-img">

            <img src="./useable/images/sale-shape-red.png" width="216" height="226" alt="get up to 50% off now"
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="./useable/images/food-menu-1.png" width="300" height="300" loading="lazy"
                    alt="Fried Chicken Unlimited" class="w-100">

                  <div class="badge">-15%</div>
<a href="order.jsp">
                  <button class="btn food-menu-btn" acti>Order Now</button>
                </a>
                </div>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="./useable/images/food-menu-2.png" width="300" height="300" loading="lazy"
                    alt="Burger King Whopper" class="w-100">

                  <div class="badge">-10%</div>
<a href="order.jsp">
                  <button class="btn food-menu-btn">Order Now</button></a>
                </div>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="./useable/images/food-menu-3.png" width="300" height="300" loading="lazy"
...
<a href="order.jsp">
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="./useable/images/food-menu-4.png" width="300" height="300" loading="lazy"
...
<a href="order.jsp">
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="./useable/images/food-menu-5.png" width="300" height="300" loading="lazy"
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="./useable/images/food-menu-6.png" width="300" height="300" loading="lazy"
      ...
      <section class="section section-divider white cta" style="background-image: url('./useable/images/hero-bg.jpg')">
        <div class="container">
...
<a href="order.jsp">
            <button class="btn btn-hover">Order Now</button></a>
          </div>

          <figure class="cta-banner">
            <img src="./useable/images/cta-banner.png" width="700" height="637" loading="lazy" alt="Burger"
              class="w-100 cta-img">

            <img src="./useable/images/sale-shape.png" width="216" height="226" loading="lazy"
     ...
     <a href="order.jsp">      <button class="btn btn-hover">Order Now</button></a> 
          </div>

          <figure class="delivery-banner">
            <img src="./useable/images/delivery-banner-bg.png" width="700" height="602" loading="lazy" alt="clouds"
              class="w-100">

            <img src="./useable/images/delivery-boy.svg" width="1000" height="880" loading="lazy" alt="delivery boy"
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <figure class="avatar">
                    <img src="./useable/images/avatar-1.jpg" width="80" height="80" loading="lazy" alt="Robert William">
                  </figure>
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <figure class="avatar">
                    <img src="./useable/images/avatar-2.jpg" width="80" height="80" loading="lazy" alt="Thomas Josef">
                  </figure>
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <figure class="avatar">
                    <img src="./useable/images/avatar-3.jpg" width="80" height="80" loading="lazy" alt="Charles Richard">
                  </figure>
          ...
          <ul class="banner-list">
            ...
            <li class="banner-item banner-lg">
              <div class="banner-card">
                ...
                <img src="./useable/images/banner-1.jpg" width="550" height="450" loading="lazy"
            ...
            <li class="banner-item banner-sm">
              <div class="banner-card">
                ...
                <img src="./useable/images/banner-2.jpg" width="550" height="465" loading="lazy" alt="Delicious Pizza"
                  class="banner-img">
            ...
            <li class="banner-item banner-sm">
              <div class="banner-card">
                ...
                <img src="./useable/images/banner-3.jpg" width="550" height="465" loading="lazy" alt="American Burgers"
                  class="banner-img">
            ...
            <li class="banner-item banner-md">
              <div class="banner-card">
                ...
                <img src="./useable/images/banner-4.jpg" width="550" height="220" loading="lazy" alt="Tasty Buzzed Pizza"
                  class="banner-img">
          ...
          <ul class="blog-list">
            ...
            <li>
              <div class="blog-card">
                ...
                <div class="card-banner">
                  <img src="./useable/images/blog-1.jpg" width="600" height="390" loading="lazy"
            ...
            <li>
              <div class="blog-card">
                ...
                <div class="card-banner">
                  <img src="./useable/images/blog-2.jpg" width="600" height="390" loading="lazy"
            ...
            <li>
              <div class="blog-card">
                ...
                <div class="card-banner">
                  <img src="./useable/images/blog-3.jpg" width="600" height="390" loading="lazy"
 ...
 <footer class="footer">
    ...
    <div class="footer-top" style="background-image: url('./useable/images/footer-illustration.png')">
      <div class="container">
        ...
        <div class="footer-brand">
          ...
          <p class="footer-text">
            Secure & trusted site for Food ordering and book Reservation .
          </p>
        ...
        <ul class="footer-list">
          ...
          <li>
            <p class="footer-list-item">+94 0123456789</p>
          </li>

          <li>
            <p class="footer-list-item">htmk@YourGmail123.com</p>
          </li>

          <li>
            <address class="footer-list-item"> kaithady west kaithady, valumpuri, jaffna 40000</address>
          </li>
    ...
    <div class="footer-bottom">
      <div class="container">
        <p class="copyright-text">
          &copy; 2023 <a href="#" class="copyright-link">Hari</a> All Rights Reserved.
        </p>
      </div>
    </div>
...
<a href="#top" class="back-top-btn" aria-label="Back to top" data-back-top-btn>
   ...
   <script src="./useable/js/script.js" defer></script>
